...
const seedData = async () => {
    try {
        await mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/kaamfinder');
        ...
        // Create sample users
        const workers = await User_1.default.insertMany([
            {
                name: 'Rajesh Kumar',
        ...
        const employers = await User_1.default.insertMany([
            {
